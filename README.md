...
Este é o microsserviço de Gestão de Inventário de um sistema de E-commerce. Desenvolvido com foco em escalabilidade, segurança e manutenibilidade, ele adota uma arquitetura em camadas (Controller, Service, Repository) e utiliza padrões rigorosos de desenvolvimento com JavaScript.
...
* **Repository Pattern:** Isolamento completo das regras de banco de dados (`warehouseRepository.js`).
...
* Visualizar todos os endpoints disponíveis (`/warehouses`, `/stock-balances`, `/inventory-transactions`).
